...
| Decision | Rationale |
|---|---|
| One single-file contract with the pinned Studio Next runner | Keeps deployment and ABI review simple and follows the supplied accepted runner baseline. |
...
Open operational facts: the Vercel production deployment is ready but protected by team SSO; Studio Next deployment, public app URL, transaction proofs, fee measurements, integration results, and production browser captures remain unverified. Local responsive screenshots are in `.impeccable/review/`.
