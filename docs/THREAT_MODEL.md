...
| Validator disagreement | The comparative validator returns disagreement for different normalized outcomes or responsibility roles, or invalid responses. Network-level rotation/appeal behavior depends on Studio Next. |
