...
const deploymentFile = resolve(root, 'deployments', 'studionet.json');
...
env.NEXT_PUBLIC_CHAIN_ID ??= '61999';
env.NEXT_PUBLIC_RPC_URL ??= 'https://studio.genlayer.com/api';
env.NEXT_PUBLIC_EXPLORER_URL ??= 'https://explorer-studio.genlayer.com';
